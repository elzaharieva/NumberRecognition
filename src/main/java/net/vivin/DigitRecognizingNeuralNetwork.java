...
public class DigitRecognizingNeuralNetwork {
	private final static String PATH_TO_FILES = "D:/DigitRecognitionVivin/src/resources";
	
    public static void main(String[] args) throws IOException {

        DigitImageLoadingService trainingService = new DigitImageLoadingService(PATH_TO_FILES + "/train/train-labels-idx1-ubyte.dat", PATH_TO_FILES + "/train/train-images-idx3-ubyte.dat");
        DigitImageLoadingService testService = new DigitImageLoadingService(PATH_TO_FILES + "/test/t10k-labels-idx1-ubyte.dat", PATH_TO_FILES + "/test/t10k-images-idx3-ubyte.dat");
